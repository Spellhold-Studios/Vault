...
IF ~~ THEN BEGIN 1THF11
  SAY @36
  IF ~~ THEN REPLY @37 JOURNAL @38 DO ~AddexperienceParty(3000) TakePartyItem("BOOK68") DestroyItem("BOOK68") GiveItemCreate("BOOKDRW",LastTalkedToBy,0,0,0) SetGlobal("ReturnNashQuest","GLOBAL",5) EscapeArea()~ EXIT
  IF ~~ THEN REPLY @39 JOURNAL @38 DO ~AddexperienceParty(3000) TakePartyItem("BOOK68") DestroyItem("BOOK68") GiveItemCreate("BOOKDRW",LastTalkedToBy,0,0,0) SetGlobal("ReturnNashQuest","GLOBAL",5) EscapeArea()~ EXIT
  IF ~~ THEN REPLY @40 JOURNAL @38 DO ~AddexperienceParty(3000) TakePartyItem("BOOK68") DestroyItem("BOOK68") GiveItemCreate("BOOKDRW",LastTalkedToBy,0,0,0) SetGlobal("ReturnNashQuest","GLOBAL",5) EscapeArea()~ EXIT
END
...
IF ~Global("ReturnNashQuest","GLOBAL",2)~ THEN BEGIN 1THF15
  SAY @49
  IF ~~ THEN REPLY @50 JOURNAL @51 DO ~ForceSpell(Myself,DRYAD_TELEPORT) CreateCreature("JC_THF03",[-1.-1],0) CreateCreature("JC_THF03",[-1.-1],0) CreateCreature("JC_THF03",[-1.-1],0) CreateCreature("STALKE",[-1.-1],0) CreateCreature("STALKE",[-1.-1],0) CreateCreature("STALKE",[-1.-1],0) SetGlobal("ReturnNashQuest","GLOBAL",3) DestroySelf()~ EXIT
END

IF ~Global("ReturnNashQuest","GLOBAL",3) Global("ReturnNashQuestZernan","GLOBAL",2)~ THEN BEGIN 1THF16
  SAY @52
  IF ~~ THEN REPLY @53 JOURNAL @54 DO ~ForceSpell(Myself,WIZARD_IMPROVED_INVISIBILITY) ChangeEnemyAlly(Myself,EVILCUTOFF) Enemy() CreateCreature("JC_THF03",[820.630],0) CreateCreature("JC_THF03",[820.630],0) CreateCreature("JC_THF03",[820.630],0) CreateCreature("JC_THF03",[-1.-1],0) ForceSpell(Myself,WIZARD_HASTE) CreateCreature("STALKE",[-1.-1],0) CreateCreature("STALKE",[-1.-1],0) CreateCreature("STALKE",[-1.-1],0) SetGlobal("ReturnNashQuest","GLOBAL",4)~ EXIT
END
